// support.js — the vendored component runtime index.html mounts through: it
// loads React, ReactDOM and Babel from unpkg (pinned, with subresource
// integrity), then renders the <x-dc> document and its <x-import> components.
// Generated bundle: treat it as an artefact, not as a file to hand-edit.
"use strict";
(() => {
      ...
      render() {
        ...
        if (this.state.__err) {
          return h(
            ...
            h(
              "div",
              { className: "sc-logic-error", "data-preview-chrome": "" },
